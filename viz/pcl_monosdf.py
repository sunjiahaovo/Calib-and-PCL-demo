...
# depth = imageio.imread(os.path.join(base_dir,  '20_depth.png'))[:,:]/1000
depth = np.load(os.path.join(base_dir,  '188main_depth_384.npy'))
...
# pcd_new = o3d.geometry.PointCloud.remove_radius_outlier(pcd, 10, 0.1)
